...
export const EVENT_DISPLAY_NAMES: Record<string, string> = {
  ...
  "Flash Manufacturing PMI": "Flash Manufacturing PMI (PMI manufacturero preliminar)",
  "Flash Services PMI": "Flash Services PMI (PMI servicios preliminar)",
  "Richmond Manufacturing Index": "Richmond Manufacturing Index (Índice manufacturero Richmond)",
  "Current Account": "Current Account (Cuenta corriente)",
  "New Home Sales": "New Home Sales (Ventas de viviendas nuevas)",
  "Bank Stress Test Results": "Bank Stress Test Results (Resultados de estrés bancario)",
  "Core PCE Price Index": "Core PCE Price Index (PCE subyacente)",
  "Final GDP": "Final GDP (PIB final)",
  "Core Durable Goods Orders": "Core Durable Goods Orders (Órdenes durables subyacentes)",
  "Durable Goods Orders": "Durable Goods Orders (Órdenes de bienes durables)",
  "Personal Income": "Personal Income (Ingresos personales)",
  "Personal Spending": "Personal Spending (Gasto personal)",
